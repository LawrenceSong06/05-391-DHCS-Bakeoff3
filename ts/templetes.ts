 ...
 */
export function create_genre_filter(genre : string){
    ...
    let checkmark : HTMLDivElement = document.createElement("div");
...
export function create_actor_select(actor : string){
